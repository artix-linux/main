...
sha512sums=('4ab0a0f5ef44d56c1af72d1fc1035566a1a89c4eeddb9e8baea675fe51c06138d913342afc8bed167d9fa55672fa25a2763ce21f7e24c1232e4739aff20733a7'
            ...
            '475ff65ad1cb8873e275c2c07a076e15d839a8679b1053e8fdd324c01bd364911a3063ad1a5cedca78ef7bf3cd052e78773e852658d0e5ff526b4b2e214bf81c')

prepare() {
  cd cdparanoia-III-$pkgver
  patch -p0 -i "$srcdir"/gcc.patch
  patch -Np1 -i ../0001-format-security.patch
}

build() {
#  export CFLAGS="$CFLAGS -Wno-format -Wno-format-security"
  cd cdparanoia-III-$pkgver
